...
是"机制已通、还差接线或数字"。每条开口都在下方 [可验收任务清单](#可验收任务清单t1t20) 里有编号任务。
...
> 要看"现在该做什么"直接跳 [可验收任务清单](#可验收任务清单t1t20)。
...
>
> **副作用（2026-07-29 由 T19 的测量挖出，已登记 T20）🔴**：agent 侧的重答会让模型**把行号全删掉**。
...
> 优化，代价是引用密度归零**——指标变好、可追溯性变差的典型。修法见 T20。
...
**T20 · agent 侧反思反馈要「修复引用」而不是「删掉引用」**〔P0-A · 0.5~1 天 · 无依赖〕🔴
